...
- New `Tags` can be added to the [settings](https://github.com/willasm/project-notes/blob/HEAD/SETTINGS.md) file
...
- Added [settings](https://github.com/willasm/project-notes/blob/HEAD/SETTINGS.md) documentation file
- Added [Upgrading from previous versions](https://github.com/willasm/project-notes/blob/HEAD/UPGRADING.md) documentation file
