...
- All `Tags` can be enabled or disabled individually in the [settings](https://github.com/willasm/project-notes/blob/HEAD/SETTINGS.md) file.
...
![Notes Example Screenshot](https://github.com/willasm/project-notes/raw/HEAD/images/NoteViews.png)

Example Highlighting Dark Theme (Dark+ default dark)....

![Dark Theme Highlighting Example Screenshot](https://github.com/willasm/project-notes/raw/HEAD/images/DemoDark.png)

Example Highlighting Light Theme (Light+ default light) ....

![Light Theme Highlighting Example Screenshot](https://github.com/willasm/project-notes/raw/HEAD/images/DemoLight.png)
...
Refer to the [settings file documentation](https://github.com/willasm/project-notes/blob/HEAD/SETTINGS.md)
...
![Example gif](https://github.com/willasm/project-notes/raw/HEAD/images/Snippets.gif)

### More examples of how to use...

![Example gif2](https://github.com/willasm/project-notes/raw/HEAD/images/Snippets2.gif)

## Release Notes
See the [Release Notes](https://github.com/willasm/project-notes/blob/HEAD/RELEASE.md) for details.
