...
* Bump Razor to 10.0.0-preview.25252.1 (PR: [#8239](https://github.com/dotnet/vscode-csharp/pull/8239))
  * If SupportDiagnostics is false then dynamic files don't report diagnostics... (PR: [#11807](https://github.com/muhammadsammy/free-vscode-csharp/issues/11807))
  * Client settings tweaks, and implement VS Code configuration monitoring (PR: [#11800](https://github.com/muhammadsammy/free-vscode-csharp/issues/11800))
  * [main] [PRERELEASE] If SupportDiagnostics then dynamic files don't report diagnostics... (PR: [#11810](https://github.com/muhammadsammy/free-vscode-csharp/issues/11810))
  * Update RazorSyntaxGenerator to reduce generated syntax code (PR: [#11806](https://github.com/muhammadsammy/free-vscode-csharp/issues/11806))
  * Improve initialization, logging, and add more features to cohosting in VS Code (PR: [#11788](https://github.com/muhammadsammy/free-vscode-csharp/issues/11788))
...
* Update Razor to 9.0.0-preview.24480.1 (PR: [#7618](https://github.com/dotnet/vscode-csharp/pull/7618))
  ...
  * Fix [#10891](https://github.com/muhammadsammy/free-vscode-csharp/issues/10891) - Formatting does not respect indentation within Razor comment blocks (PR: [#10893](https://github.com/dotnet/razor/pull/10893))
